        ...
        <div class="footer-bottom">
            <div class="auto-container">
                <div class="inner-box clearfix">
                    <figure class="footer-logo"><a href="{{ route('templates') }}"><img src="application/public/frontend/assets/images/footer-logo.png" alt=""></a></figure>
                    <div class="copyright pull-left">
                        <p><a href="{{ route('templates') }}">Realshed</a> &copy; {{ date('Y') }} All Right Reserved</p>
                    </div>
                    <ul class="footer-nav pull-right clearfix">
                        <li><a href="{{ route('templates') }}">Terms of Service</a></li>
                        <li><a href="{{ route('templates') }}">Privacy Policy</a></li>
                    </ul>
                </div>
            </div>
        </div>
