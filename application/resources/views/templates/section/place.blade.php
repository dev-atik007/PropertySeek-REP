                ...
                <div class="items-container row clearfix">
                    <div
                        ...
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{ asset('application/public/frontend/assets/images/resource/place-1.jpg') }}"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div
                        ...
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{ asset('application/public/frontend/assets/images/resource/place-2.jpg') }}"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div
                        ...
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{ asset('application/public/frontend/assets/images/resource/place-3.jpg') }}"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div
                        ...
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{ asset('application/public/frontend/assets/images/resource/place-4.jpg') }}"
                                        alt=""></figure>
                                <div class="text">
